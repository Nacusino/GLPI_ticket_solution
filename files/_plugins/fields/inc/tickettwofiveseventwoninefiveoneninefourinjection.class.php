...
class PluginFieldsTickettwofiveseventwoninefiveoneninefourInjection extends PluginFieldsTickettwofiveseventwoninefiveoneninefour implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Ticket::getTypeName() . " - Поля заявки";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Ticket', 5);
