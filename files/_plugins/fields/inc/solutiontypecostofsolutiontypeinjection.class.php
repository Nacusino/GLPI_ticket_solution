...
class PluginFieldsSolutiontypecostofsolutiontypeInjection extends PluginFieldsSolutiontypecostofsolutiontype implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return SolutionType::getTypeName() . " - Cost of solution type";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('SolutionType', 8);
