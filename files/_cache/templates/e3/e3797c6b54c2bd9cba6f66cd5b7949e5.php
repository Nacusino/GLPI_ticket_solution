...
class __TwigTemplate_ab5496df1d5383a387eb5b81c8140253 extends Template
{
    private $source;
    private $macros = [];
...
($context["withtemplate"] ?? null)], 39, $context, $this->getSourceContext());
   ...
   ";
        ...
        if (( !twig_test_empty((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 46)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["begin_date"] ?? null) : null)) &&  !twig_test_empty((($__internal_compile_1 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 46)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["duration"] ?? null) : null)))) {
         ...
         ";
            // line 49
            echo $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Infocom::getWarrantyExpir", [(($__internal_compile_2 = twig_get_attribute($this->env, $this->source,             // line 50
($context["item"] ?? null), "fields", [], "any", false, false, false, 50)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["begin_date"] ?? null) : null), (($__internal_compile_3 = twig_get_attribute($this->env, $this->source,             // line 51
($context["item"] ?? null), "fields", [], "any", false, false, false, 51)) && is_array($__internal_compile_3) || $__internal_compile_3 instanceof ArrayAccess ? ($__internal_compile_3["duration"] ?? null) : null), 0, true, ((($__internal_compile_4 = twig_get_attribute($this->env, $this->source,             // line 54
...
($context["rand"] ?? null), "min" => 1, "max" => 120, "step" => 1, "toadd" => [twig_constant("Dropdown::EMPTY_VALUE")], "unit" => "month", "add_field_html" => ((        // line 65
array_key_exists("warranty_expiration", $context)) ? (_twig_default_filter(($context["warranty_expiration"] ?? null), "")) : (""))]], 58, $context, $this->getSourceContext());
   ...
   ";
        ...
        if ((( !twig_test_empty((($__internal_compile_6 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 68)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["begin_date"] ?? null) : null)) && ((($__internal_compile_7 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 68)) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["notice"] ?? null) : null) > 0)) &&  !twig_test_empty((($__internal_compile_8 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 68)) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8["duration"] ?? null) : null)))) {
         ...
         ";
            // line 71
            echo $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Infocom::getWarrantyExpir", [(($__internal_compile_9 = twig_get_attribute($this->env, $this->source,             // line 72
($context["item"] ?? null), "fields", [], "any", false, false, false, 72)) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["begin_date"] ?? null) : null), (($__internal_compile_10 = twig_get_attribute($this->env, $this->source,             // line 73
($context["item"] ?? null), "fields", [], "any", false, false, false, 73)) && is_array($__internal_compile_10) || $__internal_compile_10 instanceof ArrayAccess ? ($__internal_compile_10["duration"] ?? null) : null), (($__internal_compile_11 = twig_get_attribute($this->env, $this->source,             // line 74
($context["item"] ?? null), "fields", [], "any", false, false, false, 74)) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["notice"] ?? null) : null), true]);
            // line 76
            echo "
      ";
...
($context["rand"] ?? null), "min" => 12, "max" => 60, "step" => 12, "toadd" => [twig_constant("Dropdown::EMPTY_VALUE"), twig_sprintf(_n("%d month", "%d months", 1), 1), twig_sprintf(_n("%d month", "%d months", 2), 2), twig_sprintf(_n("%d month", "%d months", 3), 3), 6 => twig_sprintf(_n("%d month", "%d months", 6), 6)], "unit" => "month"]], 95, $context, $this->getSourceContext());
        // line 108
        echo "
...
($context["rand"] ?? null), "min" => 12, "max" => 60, "step" => 12, "toadd" => [twig_constant("Dropdown::EMPTY_VALUE"), twig_sprintf(_n("%d month", "%d months", 1), 1), twig_sprintf(_n("%d month", "%d months", 2), 2), twig_sprintf(_n("%d month", "%d months", 3), 3), 6 => twig_sprintf(_n("%d month", "%d months", 6), 6)], "unit" => "month"]], 110, $context, $this->getSourceContext());
        // line 123
        echo "
...
";
    ...
    {
        return new Source("", "pages/management/contract.html.twig", "F:\\OSPanel\\domains\\glpi\\templates\\pages\\management\\contract.html.twig");
    }
}
