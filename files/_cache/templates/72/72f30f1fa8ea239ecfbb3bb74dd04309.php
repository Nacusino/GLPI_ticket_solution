...
class __TwigTemplate_cf16c42a13a3a05d5a1d6e812424fbc3 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_expanded"] ?? null)) ? ("col-sm-6") : (""))]], 223, $context, $this->getSourceContext());
   ...
   ";
    ...
    {
        return new Source("", "components/itilobject/service_levels.html.twig", "F:\\OSPanel\\domains\\glpi\\templates\\components\\itilobject\\service_levels.html.twig");
    }
}
